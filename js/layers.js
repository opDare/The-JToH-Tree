...
addLayer("s", {
    ...
    microtabs: {
        Tiers: {
            ...
            "Tier 2": {
                content: [
                    ["display-text", function() {return "remember to make unlocked() function after finish it"}]
                ],
                unlocked() {
                    return true
                }
...
addLayer("g", {
    ...
    tabFormat: {
        "Upgrades": {
            content: [
                "main-display",
                ["display-text", function() {return "You have total "+format(totalg)+" Grind Points"}],
    ...
    challenges: {
        11: {
            ...
            rewardDescription: "Get 1 Grand Point (GP)"
        },
        12: {
            name: "Beat ToCH",
            ChallengeDescription: "tsumetaite",
            canComplete() {return player.toch.points >= 5000},
            goalDescription: "5000 CP",
