let modInfo = {
	name: "The JToH Tree",
	id: "TJT",
	author: "op_Dare, yyyy7089, Yazmania_1m",
	pointsName: "points",
...
let changelog = `<h1>Changelog:</h1><br>
	<h2>v0.1.1: Major bug fix</h2><br>
	<h3>2024-01-20</h3><br>
			- Fixed C3(#17) Upgrade<br>
			- Fixed cost of SE4(#32)<br>
			- Added Mobile QoL to S layer<br>
			- Better update log format<br>
			- Nerfed SE3(#27) and SE4(#32) boost<br>
			- All SE upgrades must have buy SE1 to unlock<br>
	<br>
	<h3>v0.1: Start being skilled</h3><br>
	<h4>2024-01-19</h4>
