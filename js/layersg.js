//layers for challenges(G)
//display when not in any g challenge, dont touch
addLayer("gno", {
    name: "gno",
    symbol: "GNO",
    color: "#3422FF",
...
//challenge start here, all done dont touch
addLayer("toky", {
    name: "toky",
    symbol: "ToKY",
    color: "#3422FF",
...
//challenge which need to fix or not done
addLayer("toch", {
    name: "toch",
    symbol: "ToCH",
    color: "#3422FF",
